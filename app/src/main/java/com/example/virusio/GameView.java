...
public class GameView extends SurfaceView implements SurfaceHolder.Callback, SensorEventListener {
    ...
    //handles the communication from the GameThread to the view thread
    private Handler gHandler ;

    //pointers to the views
    private TextView gScoreView ;
    private TextView gStatusView ;
        ...
        gHandler = new Handler() {
            ...
            public void handleMessage(Message m) {
                if(m.getData().getBoolean("score")) {
                    gScoreView.setText(m.getData().getString("text"));
                }
                else {
                    //So it is a status
                    ...
                    switch(i) {
                        case View.VISIBLE:
                            gStatusView.setVisibility(View.VISIBLE);
                            break;
                        case View.INVISIBLE:
                            gStatusView.setVisibility(View.INVISIBLE);
                            break;
                        case View.GONE:
                            gStatusView.setVisibility(View.GONE);
                            break;
                    }

                    gStatusView.setText(m.getData().getString("text"));
                }
            }
        };
    }
    ...
    public void setScoreView(TextView mScoreView) {
        this.gScoreView = mScoreView;
    }

    public int getScore(){
        String temp = gScoreView.getText().toString();
    ...
    public void setgHandler(Handler mHandler) {
